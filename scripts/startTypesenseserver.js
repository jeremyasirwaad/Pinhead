...
const command1 = `docker run -d -p 443:443 -v/tmp/typesense-server-data/:/data typesense/typesense:0.22.2 --data-dir /data --api-key=xyz --listen-port 443 --enable-cors`;
